...
SELECT day_of_week, COUNT(*) AS total_member, member_casual
FROM BikeShare_Consolidated
WHERE member_casual = 'member'
GROUP BY day_of_week, member_casual
ORDER BY 
...
SELECT CAST(CAST(AVG(CAST(trip_duration as FLOAT)) AS DATETIME) as TIME) AS avg_ride_length_member, day_of_week, member_casual
FROM BikeShare_Consolidated
WHERE member_casual = 'member'
GROUP BY day_of_week, member_casual
ORDER BY 
...
SELECT CAST(CAST(AVG(CAST(trip_duration as FLOAT)) AS DATETIME) as TIME) AS avg_ride_length_casual, day_of_week, member_casual
FROM BikeShare_Consolidated
WHERE member_casual = 'casual'
GROUP BY day_of_week, member_casual
ORDER BY 
